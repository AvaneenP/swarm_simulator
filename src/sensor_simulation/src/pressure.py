...
class PressureSensor():
  ...
  def __init__(self):
    ...
    self.pressure_pub = rospy.Publisher(self.uavName + "/sensors/pressure", Float64, queue_size=1)
    self.position_sub = rospy.Subscriber(self.uavName + "/sensors/gps", PoseStamped, self.getPosition, queue_size = 1)
