...
class AngleCalculator():
  def __init__(self):
    ...
    self.att_pub = rospy.Publisher(self.uavName + "/sensors/attitude", Vector3, queue_size=1)
    self.imu_sub = rospy.Subscriber(self.uavName + "/sensors/filtered_imu", Imu, self.imu_callback)
